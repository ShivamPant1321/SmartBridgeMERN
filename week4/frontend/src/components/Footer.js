      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row justify-between">
          <div className="mb-6 md:mb-0">
            <h2 className="text-xl font-bold mb-2">TechStore</h2>
            <p className="text-gray-300">Quality tech products at competitive prices.</p>
          </div>
        ...
        <div className="mt-8 border-t border-gray-700 pt-6">
          <p className="text-gray-300 text-center">© {new Date().getFullYear()} TechStore. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
